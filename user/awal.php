    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title" align="center">Cart Shopping</h2>
          <p align="center"><sup><i>Hey there, click buy for shopping! Or you can add to cart and continue for shopping.</i></sup></p>
        </div>
        <div class="modal-body">
            <form action="config/prosesbuy.php" method="POST" class="form-horizontal">
   
  
        </div>
        <div class="modal-footer">
        <p align="left"><sub>Happy shopping!</sub></p>
