<div class="container">
  ...
  <div class="progress">
    <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:83%">
      83%
    </div>
  </div>
  ...
  <div class="container-fluid text-center">
    <ul class="pagination">
      ...
      <li class="active"><a href="index.php?content=buy10">10</a></li>
